...
load 'international/covid-19/gnuplot/conf_filter_for_'.field.'.gp'
...
do for [i=0:nb_countries-1] {
    ...
    set label i+10 sprintf("%s (%d)",COUNTRIES[i+1],peopleratio(STATS_max)) at STATS_index_max+offset_x, peopleratio(STATS_max) offset 0,.5 font ",12" tc rgb ctext
}
