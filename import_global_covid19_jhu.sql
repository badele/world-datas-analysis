...
DROP VIEW IF EXISTS v_global_covid19_JHU;

-- Create countries table
DROP TABLE IF EXISTS global_covid19_JHU_locations_downloaded;
CREATE TABLE IF NOT EXISTS 'global_covid19_JHU_locations_downloaded' (
  LOC_ID INTEGER,
  iso2 TEXT NULL,
  iso3 TEXT NULL,
  code3 INTEGER NULL,
...
-- import csv file
.mode csv global_covid19_JHU_locations_downloaded
.separator ","
.import '| tail -n +2 global/covid-19/datas/global_covid19_JHU_locations_downloaded.csv' global_covid19_JHU_locations_downloaded

-- Add zone fields
ALTER TABLE global_covid19_JHU_locations_downloaded ADD COLUMN zone TEXT;
UPDATE global_covid19_JHU_locations_downloaded SET zone = "country" WHERE Province_State = '';
UPDATE global_covid19_JHU_locations_downloaded SET zone = "state" WHERE Province_State != '';

-- Rename table and create index
DROP TABLE IF EXISTS global_covid19_JHU_locations;
ALTER TABLE global_covid19_JHU_locations_downloaded RENAME TO global_covid19_JHU_locations;
...
.separator ","
.import '| tail -n +2 global/covid-19/datas/global_covid19_JHU_cases_downloaded.csv' global_covid19_JHU_downloaded
.import '| tail -n +2 global/covid-19/datas/global_covid19_JHU_recovered_downloaded.csv' global_covid19_JHU_downloaded
.import '| tail -n +2 global/covid-19/datas/global_covid19_JHU_deaths_downloaded.csv' global_covid19_JHU_downloaded
